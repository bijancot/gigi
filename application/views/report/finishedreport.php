    ...
    <div class="row">
        <div class="col-md-12">
            <div class="page-title">
                <h2 class="page-desc">List of <span class="badge badge-success">FINISHED</span> Reports</h2>
            </div>
        </div>
    </div>
    <div class="row">
                            ...
                            <?php 
                                foreach($reports as $item) {
                                    ...
                                    if ($item->created_at) {
                                        ...
                                        echo '<a style="color: gray; cursor: not-allowed;"><i class="material-icons-outlined">info</i></a>';
                                    }
                                    echo '
                                            </td>
                                        </tr>
